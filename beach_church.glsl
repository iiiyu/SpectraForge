...
// Beach Church
// By Noztol
// Take the Landscape layout of https://www.shadertoy.com/view/f3XSDS
// (Golden Gardens) and Apply Voronoi layers to it to get the stained glass
// look
// =====================================================================
// Adapted for SpectraForge: uses the injected iTime / iResolution uniforms
// and the `mainImage` entry point.
