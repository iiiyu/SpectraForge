// Tunnel Shine (audio-free) for SpectraForge.
//
// SPDX-License-Identifier: CC-BY-NC-SA-4.0
// Copyright (c) 2026 @WorkingClassHacker
// Based on "Abstract Shine" by @Frostbyte (https://fragcoord.xyz/s/agoj2i8q)
// [LICENSE] https://creativecommons.org/licenses/by-nc-sa/4.0/
// Adapted to SpectraForge's mainImage entry point (u_time -> iTime,
// u_resolution -> iResolution). fragColor/i are initialized explicitly because
// SpectraForge seeds the output color to (0,0,0,1) rather than zero. Animates
...
// Approximates sin within a invisible margin for animated graphics
